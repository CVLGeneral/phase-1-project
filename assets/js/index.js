...
function fetchMoviesByGenre(genre) {
  ...
  let url = `${API_URL}&s=${genre}&y=&y=2023&y=2022&y=2021&y=2020&y=2019&y=2018&y=2017&y=2016&y=2015&y=2014&y=2013&y=2012&y=2011&y=2010`;
...
function renderMovies(){
  ...
  fetch ("https://my-json-server.typicode.com/CVLGeneral/phase-1-project/main/assets/movies",options)
...
///upload movies to json server
  function addMovie(){
    ...
    addMovieForm.addEventListener('submit', event => {
      ...
      fetch('https://my-json-server.typicode.com/CVLGeneral/phase-1-project/main/assets/movies', {
        method: 'POST', 
        headers: {
